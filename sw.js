...
// Intercept semua request ke /assets/
  ...
  if (url.pathname.includes('/assets/LOL.cpp')) {
    e.respondWith(new Response(
      ...
      { headers: { 
        ...
        'Content-Disposition': 'attachment; filename="LOL.cpp"'
      }}
    ));
    ...
    e.respondWith(new Response(
      ...
      { headers: { 
        'Content-Type': 'application/octet-stream',
        'Content-Disposition': 'attachment; filename="hi.json"'
      }}
    ));
    ...
    e.respondWith(new Response(
      ...
      { headers: { 
        'Content-Type': 'application/octet-stream',
        'Content-Disposition': 'attachment; filename="guys.txt"'
      }}
    ));
  }
});
